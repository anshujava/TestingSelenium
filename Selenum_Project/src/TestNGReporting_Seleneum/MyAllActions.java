...
import org.testng.xml.XmlSuite;
   ...
   public class MyAllActions implements IReporter{
...
//		      return r;
	 ...
	 public void LaunchBrowser(String url,String ExpectedValue,WebDriver driver) throws InterruptedException, IOException{
		...
		public void Search(String searchValue,WebDriver driver) throws InterruptedException, IOException{
			...
			Thread.sleep(5000);
			String actualTitle = driver.getTitle();
			Assert.assertEquals(actualTitle, "How to cook chicken - Go0ogle Search");
			Thread.sleep(5000);
		...
		public void SendMail(String filename2) throws MessagingException {
			 ...
			 // Recipient's email ID needs to be mentioned.
		      ...
		      try {
		         ...
		         messageBodyPart.setText("Automation Script Finished. Please find attached output.html and failed screen shot");
		         ...
		         DataSource source2 = new FileDataSource(path+filename2); 
		         ...
		         System.out.println("FAiled Sent message successfully....");
		...
		public void SendMail() throws MessagingException {
			 ...
			 // Recipient's email ID needs to be mentioned.
		      ...
		      try {
		         ...
		         System.out.println("Pass Sent message successfully....");
